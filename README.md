...
В этом репозитории вы сможете найти некоторые из моих проектов, выполненные во время обучения по специальности [Инженер по тестированию Яндекс.Практикум.](https://practicum.yandex.ru/qa-engineer-plus/). Работа в команде, стрессоустоичивость, коммуникабельность, ответственность, соблюдение сроков.
